 ...
 * easier to read, self-documenting and reduce the number of potential bugs. By
 * default, type declarations are non-strict, which means they will attempt to
 * change the original type to match the type specified by the type-declaration.
 *
 * In other words, if you pass a string to a function requiring a float, it will
